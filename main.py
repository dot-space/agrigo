...
print("\nTraining the data...\n")
training_set = train_datagen.flow_from_directory(r'C:\Users\chinm\Desktop\lol\train',
                                                target_size=(64,64),
                                                batch_size=12, #Total no. of batches
                                                class_mode='categorical')

test_set = test_datagen.flow_from_directory(r'C:\Users\chinm\Desktop\lol\test',
                                            target_size=(64,64),
                                            batch_size=12,
                                            class_mode='categorical')

classifier.fit_generator(training_set,
                         steps_per_epoch=1212, # Total training images
